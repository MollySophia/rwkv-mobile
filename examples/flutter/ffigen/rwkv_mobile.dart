...
int rwkvmobile_runtime_set_flower_template(rwkvmobile_runtime_t runtime,
int model_id,
int flower_template,
) {
  return _rwkvmobile_runtime_set_flower_template(runtime,
model_id,
flower_template,
);
}

late final _rwkvmobile_runtime_set_flower_templatePtr = _lookup<
    ffi.NativeFunction<ffi.Int Function(rwkvmobile_runtime_t , ffi.Int , ffi.Int )>>('rwkvmobile_runtime_set_flower_template');
late final _rwkvmobile_runtime_set_flower_template = _rwkvmobile_runtime_set_flower_templatePtr.asFunction<int Function(rwkvmobile_runtime_t , int , int )>();
