...
int main(int argc, char **argv) {
    ...
    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id0, (const char **)input_list0, 1, 200, callback, false, false, true);
    ...
    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id1, (const char **)input_list1, 1, 200, callback, false, false, true);
    ...
    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id0, (const char **)input_list0, 3, 200, callback, false, false, true);
    while (rwkvmobile_runtime_is_generating(runtime, model_id0)) {
        std::cout << ".";
        custom_sleep(1);
    }
    ...
    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id1, (const char **)input_list1, 3, 200, callback, false, false, true);
    while (rwkvmobile_runtime_is_generating(runtime, model_id1)) {
        std::cout << ".";
        custom_sleep(1);
    }
