...
int main(int argc, char **argv) {
    ...
    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id, (const char **)input_list, 3, 50, callback, false, false, FORCE_LANG_NONE);
    int count = 0;
    ...
    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id, (const char **)input_list, 4, 50, callback, false, false, FORCE_LANG_NONE);
    while (rwkvmobile_runtime_is_generating(runtime, model_id)) {
        std::cout << "Waiting for generation to finish..." << std::endl;
        custom_sleep(1);
    }
